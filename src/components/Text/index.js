...
const variantClasses = {
  ...
  body2:
    "font-medium lg:text-[16px] xl:text-[18px] text-[21px] 3xl:text-[25px]",
  body3: "lg:text-[15px] xl:text-[17px] text-[20px] 3xl:text-[24px]",
  body4: "lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px]",
  ...
  body8: "font-normal xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px]",
};
